    ...
    <div className="content-font">
      ...
      <form action="#" onSubmit={addNewEntry}>
        ...
        <label className="entry-label">
          On a scale of 1 to 10, one meaning "little to none" <br /> and 10
          meaning "extreme" how was your {entryState.type.toLowerCase()} level
          today?
        </label>
        <br />
        <input
        ...
        <br />
        <label className="entry-label">
          Did anything in particular contribute to your elevated level of{" "}
          {entryState.type.toLowerCase()}?
        </label>
        <br />
        <input
          type="checkbox"
        ...
        <br />
        <label className="entry-label">
          Notes for today's entry (optional):
        </label>
        <br />
        <input
          type="textarea"
