...
export default function LoginContainer() {
  ...
  const authorize = (e) => {
    ...
    if (
      loginContainerState.userNameInput ===
        getUser(loginContainerState.userNameInput).username &&
      loginContainerState.passwordInput ===
        getUser(loginContainerState.userNameInput).password
    ) {
