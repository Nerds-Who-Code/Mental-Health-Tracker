...
export default function DashboardPage() {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center bg-gradient-to-b from-cyan-200 to-blue-200 text-slate-800">
      ...
      <h2 className="text-xl m-2 dashboard-message">Welcome back {name}</h2>
      <h3 className="m-2 dashboard-message ">
        What would you like to do today?
      </h3>
      <div className="my-4 flex items-center justify-around">
        <Link to="/add-entry">
          <button className="mx-2 px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-black hover:bg-white">
            Add new entry
          </button>
        </Link>
